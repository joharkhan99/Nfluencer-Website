  ...
  return (
    <>
      ...
      <div className="p-6 pt-0">
        ...
        <div className="flex justify-between gap-20 w-full text-gray-800">
                    ...
                    <div className="flex flex-col">
                      <div className="border-b p-5 px-1 hover:bg-gray-50">
                        <Disclosure>
                          {({ open }) => (
                            <>
                              <Disclosure.Button className="flex w-full justify-between items-center text-gray-700 text-base font-semibold">
